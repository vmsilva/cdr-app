...
import IMAGEMTESTECARROSSEL from '../../../assets/IMAGEM_TESTE_CARROSSEL.png'
        ...
        <>
          ...
          >
            ...
            >
              ...
              <View
                style={
                  isTablet ? stylesTablet.blocoItemBtn : styles.blocoItemBtn
                }
              >
                {
                  array.tag_destaque != "" && ( <>
                ...
                {array.show_textos_destaque && (
                  <>
                    <View
                      style={[
                        isTablet ? stylesTablet.blocoTexto : styles.blocoTexto,{display: 'none'}
                      ]}
                    >
                      <CustomText
                        textType={"montserratBold"}
