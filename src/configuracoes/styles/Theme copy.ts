...
export const CustomDefaultTheme = {
  ...
  colors: {
    ...
    backgroundIndiceCardVideo: '#292929',
    ...
    //
    descricao_palestrante: '#FFF',

    // 
    fontPlayerPage: '#B48A36',

    // cor texto
    headerBuscaTextColor: '#FFF',
    ...
    //input busca
    backgroundInputBusca: '#333333',
    iconeSearchBar: '#787878',
    activityLoading: '#FFF',
    ...
    gradiente2: '#212121',
    gradiente3: '#111111',
    textScrollDashboard: '#FFF',
    textoBottomSheetDownload: '#FFF',
    loadingPlayer: '#FFF',
    //backgroundInputBusca: '#00000085',
