...
import { MONTACATEGORIACOMTRILHAAPRESENTADORUNICA } from "../../configuracoes/utils/utils";
import ComponenteApresentador from "./componenteApresentador";

const SinopseSerie: React.FC<any> = (props) => {
  ...
  const COMPONENTETEMPORADAS = useMemo(() => {
          ...
          categoriaHERDADA.temporadas.map((itemtemporada, index) => { 
            ...
            if(itemtemporada.videos != undefined && itemtemporada.videos != null && Object.values(itemtemporada.videos).length > 0 ){
              ...
              >
                { <AccordionGenerico
                    //isExpanded={true}
                    isExpanded={itemtemporada.palestrantes_temporada[0].nome_palestrante == item.nome_apresentador ? false : true}
                    //isExpanded={cod_categoria_temporada == itemtemporada.cod_categoria_temporada ? false : true}
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {Object.values(temporadaSelecionada.videos).length} Aulas 
            </CustomText>
          </View>
          ...
          >
            ...
            <CustomText
              ...
              textType="montserratMedium"
            >
              {temporadaSelecionada.duracao_formatada}
            </CustomText>
          </View>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {temporadaSelecionada.nome_temporada}
                      </CustomText>
                      <CustomText
                      ...
                      >
                        {temporadaSelecionada.descricao_temporada}
                      </CustomText>
                    </View>
                  </LinearGradient>
                </FastImage>
                <Animated.View style={[Styles.linha, { marginTop: -50 }]}>
                  <Animated.View style={{ paddingBottom: 30 }}>
                    ...
                    >
                      ...
                      <ComponenteApresentador item={item} />
